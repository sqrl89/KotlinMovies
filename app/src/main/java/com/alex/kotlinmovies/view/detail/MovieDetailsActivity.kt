...
//import com.alex.kotlinmovies.viewmodel.MoviesFragmentViewModel
...
////    private val mViewModel: MoviesViewModel = MoviesViewModel(RetrofitRepository())
...
////        mViewModel.getTrailers(id, APIKEY)
//
//
